...
function main()
    ...
    while (true)
        index += 1
        (x, u, dx, fx, t0, tf) = solve_NLP(ns, nx, nu, n, x, cx, u, cu, bx, bu, c_eq, c_le, b_eq, b_le, f, na, a, f_obj, na_obj, a_obj, f_int, na_int, a_int, τ, t0, tf, bt, D, W)
