...
function solve_NLP(
    ...
    @NLobjective(rocket, Max, obj_expr + wf)
...
function main()
    ...
    b_eq = Tuple{Function, Array{Real, 1}}[
        (
            ((nx, nu, na, t0, tf, r0, θ0, v_r0, v_θ0, rf, θf, v_rf, v_θf, γ0, γf) -> v_θf - 1/sqrt(rf)), []
        )
    ]
    ...
    while (true)
        index += 1
        (x, u, dx, fx, t0, tf) = solve_NLP(ns, nx, nu, n, x, cx, u, cu, bx, bu, c_eq, c_le, b_eq, b_le, f, na, a, f_obj, na_obj, a_obj, f_int, na_int, a_int, τ, t0, tf, ct, bt, D, W)
